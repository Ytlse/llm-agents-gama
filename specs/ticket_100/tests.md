...
| 5 | `scripts/tests/test_100_lot5_sorties.py` | 39 | **livré** — R43 à R50, figure unique et tableau des quatre voies compris ; le 2026-09-25, lecture des échanges au format de la passerelle et rôle lu dans `ID Personne`, puis rappel lié au souvenir de l'événement, décisions postérieures à l'exposition seules, texte cherché dans le contenu brut par section d'agent |
