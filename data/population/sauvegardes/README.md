...
| `population_1000_AAMAS_v5_2026-09-04.tar.gz` | `f141eaf29edc282f8e042a6cbf3d63f3958c21f19ef4b268c381b9ee1a6a4532` | `population_1000_AAMAS_v5/population.json` sha256 `de73532e82c84f62eb72c8a614f3c27767bf5cca1d1574d3574f4a96b65bd8ce` — règle `aamas_seal_v5` (allocation par cellule **et par taille**, 13 marges conformes sur 13) | `Temp/4_zone_enriched/toulouse_population_10000.json` (11 329 personas, pré-imputé, libellé de commune corrigé et desserte des trois réseaux) sha256 `bb8f9095ef322a03…` + brut eqasim `Temp/1_raw/toulouse_population_10000.json` + sélection `toulouse_population_1000_AAMAS[_selection].json` |
