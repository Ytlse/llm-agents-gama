...
*Généré le 2026-09-25 06:21:28 par `modal_variation_rate.py`*
...
| **3. Post-choc immédiat (J10-14)** | 22 | **9.1%** | 90.9% | 95.5% | 4.5% |
| **4. Post-choc tardif (J15-21+)** | 222 | **8.1%** | 91.9% | 69.4% | 30.6% |
...
|---|:---:|:---:|:---:|:---:|:---:|
| **Achats** | 26 | **100.0%** | 0.0% | 0.0% | `Très Rigide` |
| **Travail** | 26 | **80.8%** | 33.3% | 18.2% | `Modérée` |
| **home** | 30 | **73.3%** | 100.0% | 8.3% | `Modérée` |
| **other** | 29 | **72.4%** | 100.0% | 8.7% | `Modérée` |
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **861500** | 288 | 4 | **1.133** | 0.488 | 1.369 | 1.052 | Multimodal |
...
- **Volume total de décisions enregistrées :** 288
- **Délibérations LLM effectives :** 209 (72.6%)
- **Replis techniques d'urgence :** 0 (100% des décisions ont été délibérées ou contraintes par l'offre physique)
- **Choix physiquement contraints (un seul itinéraire disponible) :** 79 (27.4%)
