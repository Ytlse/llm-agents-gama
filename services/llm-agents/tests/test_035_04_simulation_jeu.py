...
def test_G14_jeu_stats_et_rapport(banc, tmp_path):
    ...
    # 5 attendus sur le banc : la journée se referme (p3 : a0→a1, a1→a2, a2→a0 ; p2 : b0→b1, b1→b0),
    # et la boucle HOME → HOME de p3 compte dans les attendus bruts même si elle reste inexploitable.
