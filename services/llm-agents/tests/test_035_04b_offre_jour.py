...
def test_verification_gtfs_par_fenetre(banc):
    ...
    # La journée refermée (ticket 045) ajoute deux déplacements, tous deux servables : la fermeture de
    # p2 (b1 → b0) part à 23 h 45, hors fenêtre, et celle de p3 (a2 → a0) va de HOME à HOME, donc sans
    # aucune proposition TC — rien à y recalculer. 5 déplacements = 2 invalides + 3 valides.
