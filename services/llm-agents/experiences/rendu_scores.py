...
def rendu(
    ...
    # En-tête : composite (les deux losses), L1 global, couverture (R9), et les deux
    # grandeurs du ticket 047 — la seconde lecture du composite et le compte qui l'explique.
    # Elles sont dans l'en-tête et non en annexe : le composite principal compte des
    # décisions que personne n'a prises, et rien d'autre sur cette page ne le dit.
    ...
    # Ticket 047 — la page est autonome : elle se lit sans le journal de scoring, donc elle
    # porte elle-même l'écart entre les deux lectures quand il est décisif.
