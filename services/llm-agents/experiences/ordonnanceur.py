...
# Le fichier compose vit dans infra/ (ticket 039) : il faut le désigner, et
# `--project-directory` garde la racine du dépôt comme base des chemins relatifs
# qu'il contient. Sans ce second drapeau, compose réancre tout sur infra/.
_EXEC_BASE = [
    "docker",
    "compose",
    "-f",
