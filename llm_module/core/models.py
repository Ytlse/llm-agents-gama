"""Shim de compatibilité — `llm_module.core.models` a déménagé dans `llm_gateway.core.models`.
...
_warnings.warn(
    "llm_module.core.models est déprécié : importez llm_gateway.core.models (retrait prévu en 2.0).",
    DeprecationWarning,
    stacklevel=2,
)
