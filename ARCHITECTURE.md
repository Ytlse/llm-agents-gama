...
4. [GAMA — Moteur de simulation multi-agents](#4-gama--moteur-de-simulation-multi-agents)
5. [Controller — Cerveau Python de la simulation](#5-controller--cerveau-python-de-la-simulation)
6. [LLM Module — Passerelle d'inférence LLM](#6-llm-module--passerelle-dinférence-llm)
7. [OpenTripPlanner — Moteur de routage multimodal](#7-opentripplanner--moteur-de-routage-multimodal)
8. [Infrastructure transversale](#8-infrastructure-transversale)
9. [Observabilité](#9-observabilité)
10. [Schéma réseau Docker](#10-schéma-réseau-docker)
...
| `otp` | `./otp-toulouse` | 8080 | Moteur de routage multimodal (bus, tram, métro, marche) |
...
1. `docker compose up` (tous les services Docker)
...
GAMA démarre
  └─► POST http://controller:8002/init
        └─► SimulationLoopV1.initialize()
              ├─ Chargement population synthétique (CSV)
...
## 4. GAMA — Moteur de simulation multi-agents
...
## 5. Controller — Cerveau Python de la simulation
...
## 6. LLM Module — Passerelle d'inférence LLM
...
## 7. OpenTripPlanner — Moteur de routage multimodal
...
└─────────────────────────────────────────────────────────────────────┘
           ...
           │
    8000 | 8002 | 8080 | 5555 | 9090 | 3000 | 9100 | 6379
```
