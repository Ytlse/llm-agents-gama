...
| **`google_gemini31`** | `google` | `gemini-3.1-flash-lite` | **15** | 250 000 | **500** | — | **1.0** (10.1%) | 2 | **Juge de référence** (calibration des prompts) |
| **`google_gemini35`** | `google` | `gemini-3.5-flash-lite` | **15** | 250 000 | **500** | — | **1.0** (10.1%) | 2 | **Mutateur & Générateur** (+ thinking 1024) |
| **`google2`** | `google` | `gemini-3.1-flash-lite` | **15** | 250 000 | **500** | — | **1.0** (10.1%) | 2 | Seconde clé Google (mesures hors campagne) |
...
1. **Le Juge d'Évaluation (`google_gemini31`)** :
   - Modèle : `gemini-3.1-flash-lite` (l'alias `-preview`, retiré côté Google, était servi
     par ce même modèle sans erreur — corrigé le 2026-09-10)
