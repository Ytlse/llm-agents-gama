...
%   app:unit      — Appendix I, the unit audit. Referenced by overleaf/06_results.tex.
...
%   The two figures of the unit audit are carried by overleaf/06_results.tex, not by this file.
...
The two figures of this audit are in Section~\ref{sec:agreement}, Figures~\ref{fig:audit-modes} and~\ref{fig:audit-distance}.
