...
**Document :** version alternative du chapitre 6. Le chapitre de référence, [`../06_results.md`](../06_results.md), tient treize décideurs ; celui-ci en tient quinze, les deux bras Jev 1.13 du [ticket 096](../../../../tickets/ticket_096_jev_typesafe_troisieme_famille_de_decideur.md) en plus.
...
|---|---:|---:|---:|---:|
| Gradient boosté | 71,5 | 0,419 | 20,4 | 63,4 |
| Logit multinomial | 68,6 | 0,478 | 18,3 | 60,0 |
| Durée minimale | 68,1 | — | 25,8 | 19,2 |
| Prompt expert `gemini-3.5` | 67,6 | **0,356** | 22,5 | 47,2 |
| Prompt minimal `gemini-3.5` | 64,8 | 0,460 | 24,1 | 44,2 |
| Prompt réglé pour lui, Jev *(en échantillon)* | 64,7 | 0,625 | 18,1 | 56,3 |
| Prompt expert Jev | 64,3 | 0,655 | 16,9 | 63,1 |
| Prompt minimal Jev | 56,6 | 0,703 | 19,0 | 43,3 |

*Huit décideurs sur douze, en pourcentage sauf l'entropie croisée. Les quatre autres et les colonnes de précision sont à l'annexe I.*

<!-- source: docs/traces/2026-09-21_jev_mutations/audit_unitaire_avec_proexp32.json, rejeu complet de scripts/progedo_logit/audit_unitaire_058.py le 2026-09-21 après ajout du bras exp_jev-1130_proexp32_jtir_pop-enquete_058_test_jeu-58_test_20260316_nosim (exécution 2026-09-21_11_56_48, 9 614 déplacements notés). Entropie croisée = cel_weighted, sur l'ensemble des notés ; sur le support commun aux neuf décideurs qui rendent une distribution (5 229 décisions), les deux bras donnent 0,464 et 0,509. Rappels et précisions par mode : par_mode du même fichier. -->


L'ordre change avec la grandeur lue. Sur l'exactitude, le prompt expert à modèle de langue est sixième des onze décideurs ; sur l'entropie croisée il passe devant les quatre méthodes tabulaires. Il se trompe à peu près aussi souvent qu'elles, et laisse davantage de masse au mode déclaré quand il se trompe.

Jev fournit le cas extrême, et il va contre ce que le § 6.1 laissait attendre. Aucune comparaison appariée ne le sépare des quatre méthodes tabulaires sur la répartition agrégée ; sur les journées déclarées il est neuvième des onze, à 64,3 % d'exactitude pondérée, sous le plancher tout-voiture qui fait 66,7 %, et son entropie croisée de 0,655 est la plus mauvaise de tous les décideurs qui rendent une distribution. Étaler la masse ne suffit donc pas : encore faut-il qu'elle tombe sur le mode déclaré, et le rappel des transports collectifs dit où elle tombe à la place — 35,0 % contre 55,2 % au prompt expert à modèle de langue, quand le rappel de la marche monte à 63,1 %, le meilleur hors méthodes tabulaires. Un décideur peut restituer la répartition d'un territoire en se trompant sur un tiers des individus de plus que le meilleur, et le composite du § 6.1 ne l'en départage pas.

La consigne réglée pour lui déplace l'audit dans le même sens que le § 6.1, et d'aussi peu. L'exactitude pondérée passe de 64,3 à 64,7, l'entropie croisée de 0,655 à 0,625, et le mode déclaré cesse de recevoir une masse nulle sur 23 décisions de plus. Le déplacement porte presque entièrement sur un mode : le rappel des transports collectifs monte de 35,0 à 43,8, pris sur celui de la marche qui descend de 63,1 à 56,3. La clause mutée ne parle pourtant ni de l'un ni de l'autre ; elle met le coût d'une marche continue en regard de la friction d'une chaîne, et c'est le partage entre ces deux modes-là qu'elle refait. Sur les deux grandeurs qui classent, l'exactitude et l'entropie, le bras reste neuvième des douze et sous le plancher tout-voiture.
