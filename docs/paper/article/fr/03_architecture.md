...
Le dispositif couple trois composants. Une simulation multi-agents GAMA porte le monde : la géographie réelle de l'aire toulousaine, les réseaux, l'horloge, et l'exécution physique des déplacements. Un contrôleur conduit le cycle de vie des agents : il détecte qu'un agent doit partir et construit l'offre d'itinéraires réellement disponible à cette heure-là. Un module de décision produit le choix lui-même : c'est là, et seulement là, qu'intervient le modèle de langue.
...
Le rappel combine cinq termes, sur une fenêtre d'âge égale à l'horizon de l'expérience, soixante jours au plus : proximité sémantique, gravité du souvenir, décroissance temporelle, appariement de la météo, et une affinité conjointe de lieu, de créneau et de motif. Le modèle reçoit ce que l'agent en a agrégé : ce qu'il fait le plus souvent, ce qu'il tient pour vrai, ce qui vient de changer. Trois souvenirs choisis pour ce déplacement s'y ajoutent. <!-- source: docs/arch/memory-stm-ltm.md, partie III ; ticket 071 § 2.2 et § 2.4 -->

Une arrivée tardive avance la cible horaire de l'activité, de 75 % du retard constaté, sans jamais empiéter sur l'activité précédente ni sur la suivante. Le réajustement est écrit en mémoire à la première personne, si bien que l'agent pourra le relire en décidant demain. Il est produit par l'écart entre l'horaire prévu et l'horaire vécu, sans passer par le modèle de langue. <!-- source: llm-agents/urban_mobility_agents/simulation_controller.py, reschedule_amount ; settings.agent.reschedule_transition_ratio = 0.75 -->

## 3.5 Modélisation par chaînes de déplacements

Un agent parti travailler à vélo n'a pas de voiture au bureau le soir : les déplacements d'une journée sont liés par la position des véhicules.
...
Une part de la répartition modale simulée est produite sous ces contraintes, et le chapitre 6 y revient : un agent dont la voiture est restée au domicile ne peut pas conduire. Le plancher et le plafond du chapitre 4 sont soumis aux mêmes contraintes.
