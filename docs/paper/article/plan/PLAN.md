...
4. MÉTRIQUES ET SOCLE D'ÉVALUATION                 brouillon v0.9 — article/fr/04_Evaluation.md
...
5. QUATRE FAÇONS DE CHOISIR, UNE SEULE INFORMATION  trame — article/fr/05_Protocol.md
...
6. ÉVALUATION EMPIRIQUE                            trame — article/fr/06_Empirical_Evaluation.md
   -- le chapitre de RÉSULTATS. Son idée directrice n'est PAS tranchée : les scores recalculés le
      ...
      de nature). Le titre, lui, est arrêté depuis le 2026-09-22 : « Empirical Evaluation ».
...
7. ADAPTATION AUX CHOCS EXTERNES                   brouillon — article/fr/07_Adaptation.md
   7.1 Le mécanisme commun aux deux régimes : l'entrée en mémoire, l'estimation faite par
       l'agent, le récit du soir au foyer, et les deux voies d'extinction
   7.2 Le choc vécu par un agent seul : le canal par lequel l'effet est passé, le dispositif,
       les résultats
   7.3 L'article lu, puis raconté en famille : cinq événements, trois conditions, les vingt
       signes préenregistrés
   -- ÉTAT AU 2026-09-22 : rédigé en `brouillon v2.1`. Le choc passe AVANT la presse, dans
      l'ordre de ce plan. Seul le § 7.2 porte des résultats ; la campagne du § 7.3 n'est pas
      jouée. Trois sous-sections : ni conclusion (retirée le 21 septembre) ni § 7.4 de mesures
      communes (retiré le 22, sa colonne mesurée étant déjà au § 7.2.1).

8. LIMITES ET IMPLICATIONS HYBRIDES                brouillon — article/fr/08_Limitations.md
