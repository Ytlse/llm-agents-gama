...
**Document:** chapter 8 of the AAMAS 2027 paper. English master; French mirror in [`fr/08_Limitations.md`](../fr/08_Limitations.md); LaTeX rendering for Overleaf in [`overleaf/chapters/08_Limitations.tex`](../overleaf/chapters/08_Limitations.tex).
