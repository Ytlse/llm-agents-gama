...
**Version :** `v1.3` (2 septembre 2026) — *Règles de comparabilité (argmax, renormalisation sur l'offre, effectif), requalification du jalon 0 en contrôle de cohérence, plan de l'évaluation écologique porté à cinq conditions et critères de réfutation explicites*  
**Fichiers associés :** [`MANUSCRIT_DETAILLE_2026.md`](MANUSCRIT_DETAILLE_2026.md), [`PLAN_ARTICLE_2026.md`](PLAN_ARTICLE_2026.md), [`SLIDES_SEMINAIRE_2026_v1.0.html`](SLIDES_SEMINAIRE_2026_v1.0.html)
