...
Une autre valeur accompagne le composite, toutes deux publiées ensemble : l'erreur L1 sur les parts globales, soit la somme des écarts absolus en points de pourcentage.
...
\begin{table*}[tp]
  \caption{Les quinze décideurs sur les deux lectures, avec l'intervalle inter-semences où il a été mesuré. Plus le score est bas, meilleur il est sur les deux lectures.}
  \label{tab:scale}
  \begin{tabular}{lrrl}
    \toprule
    Décideur & Composite & L1 sur les parts globales & Intervalle inter-semences \\
    \midrule
    Aléatoire uniforme                                     & 50,16 & 86,80 & déterministe \\
    Tout-voiture                                           & 30,73 & 58,00 & déterministe \\
    Durée minimale                                         & 26,97 & 53,62 & déterministe \\
    Invite minimale, \texttt{mistral-large}                & 14,75 & 44,71 & non rejoué \\
    Invite minimale, classificateur typé                   & 13,75 & 42,76 & non rejoué \\
    Invite minimale, \texttt{gemini-3.1}                   & 12,38 & 39,88 & non rejoué \\
    Invite minimale, \texttt{gemini-3.5}                   &  7,02 & 24,08 & \textbf{[en attente]} \\
    Invite experte, \texttt{gemini-3.1}                    &  8,98 & 31,25 & non rejoué \\
    Invite experte, \texttt{mistral-large}                 &  7,63 & 26,64 & non rejoué \\
    Invite experte, \texttt{gemini-3.5}                    &  4,86 & 13,85 & 0,56 \\
    Logit multinomial                                      &  4,02 &  8,99 & déterministe \\
    Forêt aléatoire                                        &  4,09 &  5,28 & déterministe \\
    Invite experte, classificateur typé                    &  3,65 & 10,48 & 0,05 \\
    Régression logistique à noyau                          &  3,61 &  6,69 & déterministe \\
    Gradient boosting                                      &  3,60 &  9,49 & déterministe \\
    \bottomrule
  \end{tabular}
\end{table*}
