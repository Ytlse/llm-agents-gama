...
Every score of Table~\ref{tab:scale} comes from one sealed cohort of 1{,}000 synthetic
...
repository\footnote{\url{https://anonymous.4open.science/XXXX}}. Our data-use agreement forbids
...
does not list. Section~\ref{sec:deliberation} adds one check on a second cohort. Appendix D
gives the three prompts in full, the generation settings, and the decisions each produced for
one trip.
