% =====================================================================
% chapters/08_Appendices.tex — LaTeX rendering of ../sections/08_appendices.en.md (2026-09-24 14:58:01)
...
% Written by hand on 24 September 2026 (no generator, see ../sections/README.md). Only
%   Appendix D exists. \setcounter{section}{3} makes it print as "D": remove that line when
%   A, B and C are written above it.
...
% Not carried: the <!-- source: --> comments of the master (provenance trace, as in the paper).
% =====================================================================
...
\section{The three prompts, and one trip decided under each}
\label{app:prompts}
...
words, schema excluded, and the prompt file holds it under the key
...
part of the journey. The other lines are those of Appendix~\ref{app:expert}. It runs to 318
...
from each distribution, under the same seed in the three runs.
...
The message gives 28\,\textdegree{}C and partly cloudy skies, with rain in the morning only.
The second sentence names none of the four criteria.

Under both prompts, \texttt{gemini-3.5} gives the three bus options ten percent at most,
together. The expert prompt takes forty points from the car and ten from the bus, and gives
