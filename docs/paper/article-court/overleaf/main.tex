...
\input{repository}    % \repobase, \repodisplay: the anonymised repository (TBD until submission)
...
\title[Where Chain-of-Thought Earns Its Place]{Where Chain-of-Thought Earns Its Place:
Generative Mobility Agents Against a Real Household Travel Survey}
...
Distributional Alignment, GAMA Platform}
