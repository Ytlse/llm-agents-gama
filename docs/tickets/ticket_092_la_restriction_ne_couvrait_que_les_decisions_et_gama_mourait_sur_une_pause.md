# Ticket 092 — La restriction ne couvrait que les décisions, et GAMA mourait sur une pause

> Le statut de ce ticket vit dans `scripts/dashboard/tickets_status.yaml`, seule source de vérité.
> Ouvert et **livré le 2026-09-16**, 11 tests dédiés. Contrat : `specs/ticket_092/tests.md`,
> écrit avant le code.
>
