...
> 2026-09-03 (`docs/paper/methode/population/RAPPORT_PERIMETRE_453_COMMUNES.html`) : le périmètre
...
- **Sceau** : MANIFEST avec `perimetre` (définition, départements attendus / retenus, activités hors
  ...
  `docs/paper/methode/population/synthese_representativite_v3_population_v4_2026-09-03.html` (générateur
...
- **Pages du 2026-09-03 au soir** : la synthèse de représentativité v3 est régénérée avec le verdict vélo
  ...
  la page `docs/paper/methode/population/fabrication_population_v4_2026-09-03.html` explique la fabrication de
...
10. **La largeur du périmètre est fausse dans le rapport de périmètre** (`docs/paper/methode/population/
