...
mesure + journal de construction OTP).
...
| OTP T2 / T6 | **reporté** | GTFS liO non téléchargé (porte d'approbation) ; conséquence mesurée : 364 points sans arrêt à portée |
