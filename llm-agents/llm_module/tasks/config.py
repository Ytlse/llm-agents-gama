...
class ProviderConfig(BaseModel):
    ...
    def __repr__(self) -> str:
        return f"ProviderConfig(rpm_limit={self.rpm_limit}, model='{self.default_model}', base_url='{self.base_url}', weight={self.weight}, api_length={len(self.api_key.get_secret_value())})"
