...
La ressource (`mobility_core/data/zf_housing_type.json`) est produite par
...
pur, conformément au contrat d'architecture de `mobility_core`.
"""
...
# Ressource d'ACCÈS RESTREINT : elle publie l'effectif par zone fine (médiane 12 ménages,
# 195 zones sous 5), donc elle ne part ni dans le dépôt ni dans le paquet (ticket 038).
RESOURCE_NAME = "zf_housing_type.json"

# Évalué à l'import, pour les appelants qui testent son existence ; `load()` re-résout.
