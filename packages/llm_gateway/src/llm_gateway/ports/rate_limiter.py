...
class RateLimiter(Protocol):
    ...
    # Ticket 105 — le suffixe fait partie du contrat : ces deux compteurs ne voient que le
    # trafic de CETTE passerelle, alors que la même clé d'API sert aussi à `scripts/synthesis/*`
    # et `prompt_calibration`. Indicatifs : ils ne ferment jamais une clé. Seul le 429 du
    # fournisseur le fait, via `mark_quota_exhausted_until`.
